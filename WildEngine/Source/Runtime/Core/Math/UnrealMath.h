...
#include "Matrix/RotationTranslationMatrix.h"
#include "Matrix/ScaleRotationTranslationMatrix.h"
#include "Matrix/RotationMatrix.h"
#include "Quat.h"
#include "Matrix/PerspectiveMatrix.h"
#include "Matrix/OrthoMatrix.h"
#include "Matrix/TranslationMatrix.h"
#include "Matrix/QuatRotationTranslationMatrix.h"
#include "Matrix/InverseRotationMatrix.h"
#include "Matrix/ScaleMatrix.h"
#include "Matrix/MirrorMatrix.h"
#include "Matrix/ClipProjectionMatrix.h"
#include "Transform.h"
...
inline FVector FVector2D::SphericalToUnitCartesian() const
{
	...
	return {FMath::Cos(Y) * SinTheta, FMath::Sin(Y) * SinTheta, FMath::Cos(X)};
}
...
template<class U>
FRotator FMath::Lerp( const FRotator& A, const FRotator& B, const U& Alpha)
{
...
template<class U>
FQuat FMath::Lerp( const FQuat& A, const FQuat& B, const U& Alpha)
{
	return FQuat::Slerp(A, B, Alpha);
}

template<class U>
FQuat FMath::BiLerp(const FQuat& P00, const FQuat& P10, const FQuat& P01, const FQuat& P11, float FracX, float FracY)
{
	FQuat Result;
...
template<class U>
FQuat FMath::CubicInterp( const FQuat& P0, const FQuat& T0, const FQuat& P1, const FQuat& T1, const U& A)
{
